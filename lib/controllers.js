...
module.exports.getToken = function(req, res) {
  if (!req.user) {
    res.json(500, { error: 'Unhandled API Authentication Error.' });
    // unhandled framework error, no idea how we got here cuz helpers.getUser should
    // have handled all this by breaking if authenticateApiRequest returns an error
  } else {
