...
function setAccountStoreByHref(accountData, accountStore) {
  // Naming this `accountData` is confusing, it's actually
  // an object (as used, a request body or form object)
  // that will eventually authentication request
...
function setMultiTenancyFields(req, viewModel) {
  ...
  // use lodash for fetching this field?
