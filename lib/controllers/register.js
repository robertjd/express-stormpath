...
module.exports = function (req, res, next) {
  ...
  function handleResponse(account, responseHandler) {
    ...
    // developer should use the post registration handler to send the email
            ...
            handlePreRegistration(req.body, function (err) {
              ...
              helpers.validateAccount(req.body, config, function (errors) {
                ...
                helpers.prepAccountData(req.body, config, function (accountData) {
                  ...
                  oktaUser.profile.emailVerificationToken = uuid();
                      ...
                      function userCreationErrorMapper(err) {
                        if (err && err.errorCauses) {
                          err.errorCauses.forEach(function (cause) {
                            if (cause.summary === 'login: An object with this field already exists in the current organization') {
